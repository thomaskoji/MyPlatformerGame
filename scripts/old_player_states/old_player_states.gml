function old_player_state_wait() {
	if(state_new)
	{
...
function old_player_state_brake() {
	if(state_new)
	{
...
function old_player_state_jump() {
...
function old_player_state_backflip() {
	if(state_new and !jumped)
	{
		image_speed = defaultImageSpeed;
...
function old_player_state_fall() {
	if(state_new)
	{
...
function old_player_state_slide() {
	if(state_new)
	{
...
function old_player_state_wallJump() {
	if(state_new)
	{
		image_speed = defaultImageSpeed;
		sprite_index = spr_playerJump;
...
function old_player_state_wallLatch() {
	if(state_new)
	{
		image_speed = defaultImageSpeed;
...
function old_player_state_wallRun() {
	if(state_new and !jumped)
	{
...
function old_player_state_ledgeGrab() {
	if(state_new and !jumped)
	{
...
function old_player_state_push() {
	if(state_new)
	{
		image_speed = defaultImageSpeed;
